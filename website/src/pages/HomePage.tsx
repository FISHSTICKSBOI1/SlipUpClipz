...
import { DemoSection, openDemoVideo } from '../components/DemoSection'
        ...
        <div className="site-container grid items-center gap-12 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 lg:py-24">
          <div className="motion-safe:animate-fade-up">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button type="button" variant="secondary" className="btn-lift" onClick={openDemoVideo}>
                Watch Demo
              </Button>
            </div>
          ...
          <ScreenshotFrame
            shot="clips"
            alt="SlipUpClipz Clips page — full app view with replay buffer and clip library"
            float
            priority
            className="motion-safe:animate-fade-up lg:justify-self-end"
          />
        </div>
      </section>
      ...
      <section className="section-space border-y border-ink-border/70 bg-ink-raised/30">
        <div className="site-container">
          <SectionHeading
            ...
            description="$4.99/year. Windows only."
          />
          <div className="mx-auto mt-10 max-w-4xl">
            <PricingCards />
          </div>
